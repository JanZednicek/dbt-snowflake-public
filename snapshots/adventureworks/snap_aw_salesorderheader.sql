...
-----------------------------------------------------------------------------
  ...
  About this table:
    - Table:    snap_aw_salesorderheader.sql
    - Schema:   staging | db based on your --target (profiles.yml)
    - Source:   adventureworks database (sqlservercentral.com) - table salesorderheader.sql | Data extracted using fivetran
...
{% snapshot snap_aw_salesorderheader %}
