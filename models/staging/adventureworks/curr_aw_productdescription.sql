...
-----------------------------------------------------------------------------
  ...
  About this table:
    - Table:   curr_aw_productdescription.sql
    - Schema:  staging | db based on your --target (profiles.yml)
    - Source:  staging schema - snap_aw_productdescription.sql
...
select * 
from {{ source('ADVENTUREWORKS_SNAPSHOTS', 'SNAP_AW_PRODUCTDESCRIPTION') }} 
